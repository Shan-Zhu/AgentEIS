...
train_dataset_json_path = "eis_dataset_train.json"
val_dataset_json_path = "eis_dataset_val.json"
output_dir = "./output/Qwen2___5-VL-3B-EIS"
MAX_LENGTH = 100000
...
origin_model = Qwen2_5_VLForConditionalGeneration.from_pretrained(
    local_model_path, 
    device_map="cuda",  # 将auto改为cuda，强制使用CUDA设备
...
swanlab_callback = SwanLabCallback(
    project="Qwen2.5-VL-3B-eis",
    experiment_name="3B-eis",
    config={
        "model": "https://modelscope.cn/models/Qwen/Qwen25-VL-3B-Instruct",
...
# 保存到CSV文件
csv_path = "./prediction_results_qwenVL2_5-3B.csv"
